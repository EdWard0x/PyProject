...
def ConfirmRequest(ticket):
    ...
    headers = {
        'DS': '',
        'cookie': 'stuid=360269808;stoken=v2_lWb8aueJ62HWw5KVEBe1Phr7K1qpWdiJrvdk95Z35vQpf35RY45nFG7WFohunGmwy3lOZyvEbdE_O26-ysxKqbVYUsXJSxkLBYB_cQdcTMCyFgV01KDQ7A==;mid=0c0tcrl9jh_mhy;login_ticket=6N6ZiMejHfeHnUFX3Gk1s8ixXmC3IVBlW52uzfyF',
        'x-rpc-client_type': '1',
    ...
    conn.request("GET", "/auth/api/getGameToken?uid=360269808",
                 payload, headers)
    res = conn.getresponse()
    data = res.read()
    ...
    payload = json.dumps({
        ...
        "payload": {
            "proto": "Account",
            "raw": f"{{\"uid\":\"360269808\",\"token\":\"{token}\"}}"
        },
        "ticket": ticket
    })
    headers = {

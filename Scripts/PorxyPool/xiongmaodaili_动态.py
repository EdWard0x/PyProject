...
orderno = "GL201812171444364epf7o8k"
secret = "bcdeb582d785c62aec7e4151bb6993eb"
...
# r = requests.get("https://ip.cn/api/index?ip=&type=0",headers=headers,proxies=proxy,verify=False,allow_redirects=False)
print(r.encoding)
